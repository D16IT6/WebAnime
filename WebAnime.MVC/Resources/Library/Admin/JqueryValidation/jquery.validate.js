    ...
    $.extend($.validator,
        {
            ...
            prototype: {
                ...
                element: function(element) {
                    ...
                    const result = this.check(element);
                    if (result) {
                ...
                check: function(element) {
                    ...
                    for (let method in rules) {
                        ...
                        try {
                            const result = $.validator.methods[method].call(this,
                            ...
                            this.settings.debug &&
                                window.console &&
                                console.log(
                                    `exception occured when checking element ${element.id}, check the '${rule.method
                                    }' method`,
                                    e);
                            throw e;
                        }
            ...
            attributeRules: function(element) {
                ...
                for (let method in $.validator.methods) {
                    const value = $element.attr(method);
                    if (value) {
                        rules[method] = value;
                    }
                }
            ...
            metadataRules: function(element) {
                ...
                const meta = $.data(element.form, "validator").settings.meta;
            ...
            methods: {
                ...
                rangelength: function(value, element, param) {
                    const length = this.getLength($.trim(value), element);
                ...
                equalTo: function(value, element, param) {
                    ...
                    const target = $(param).unbind(".validate-equalTo").bind("blur.validate-equalTo",
                        function() {
                            $(element).valid();
                        });
